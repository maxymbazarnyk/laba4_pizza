        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShopCart_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.InsertData(
                table: "UserAccounts",
                columns: new[] { "Id", "Email", "Name", "Password", "Phone", "RoleId", "Type" },
                values: new object[] { 1, "admin@gmail.com", "Admin", "12345", "380688303152", 1, 1 });
